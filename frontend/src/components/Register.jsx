...
const FIRSTNAME_REGEX = /^[a-zA-Z]{2,40}$/;
const LASTNAME_REGEX = /^[a-zA-Z]{2,40}$/;
const PWD_REGEX = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%]).{8,24}$/;
const ADDRESS_REGEX = /^[0-9]{1,5} [A-z][A-z0-9-_]{3,23}$/;
const ZIPCODE_REGEX = /^[0-9-]{1,5}$/;
const REGISTER_URL = '/register';

// government_org: bool (dropdown)
// address_1: str
// address_2: str
// city: str
// state: str (dropdown)
...
const Register = () => {
    ...
    // State for possible error msgs and success
                ...
                <section>
                    ...
                    <label htmlFor="email">
                        ...
                        <p id="uidnote" className={emailFocus && email && !validEmail ? "instructions" : "offscreen"}>
                            ...
                            Format is email_user@email_host.com
                        </p>
                        ...
                        />
                        <p id="uidnote" className={zipCodeFocus && zipcode && !validZipCode ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            4 to 24 characters.<br />
                            Must begin with a letter.<br />
                            Letters only allowed.
                        ...
                        <button disabled={!validLastName || !validPwd || !validMatch ? true : false}>Sign Up</button>
                    </form>
                    <p>
